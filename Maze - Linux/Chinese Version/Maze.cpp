 ...
 * Last modified date: 5th March, 2017 && Code Length: 412 Lines in Ubuntu 16
...
int main()
{
	...
	{
		printf( "你已经被困在迷宫里了\n嘿 嘿 嘿\n" );
		printmaze( 0, 0 );	{ printf("Press Enter To Continue."); getchar(); getchar(); }
	}
		...
		for ( int step = 0; step < 4; step++ )
		{
				...
				!maze[x + dx[step]][y + dy[step]] )
			{
				...
				if ( xstep == terminalx && ystep == terminaly )
				{
					...
					{ printf("Press Enter To Continue."); getchar(); getchar(); } exit( 0 );
				}
			}
		}
